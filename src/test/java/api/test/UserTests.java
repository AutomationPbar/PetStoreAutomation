...
logger= LogManager.getLogger(this.getClass());
	...
	Response response=UserEndpoints.readUser(this.user_payload.getUsername());
	...
	public void testUpdateUser() {
		...
		Response updateresponse= UserEndpoints.readUser(this.user_payload.getUsername());
	...
	public void testDeleteUser() {
		...
		Response res = UserEndpoints.deleteUser(this.user_payload.getUsername());
